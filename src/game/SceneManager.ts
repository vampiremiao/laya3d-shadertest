...
module game {
	export class SceneManager {
		...
		private sceneLoaded(): void {
			...
			//添加照相机channel
			this.camera = (this.scene.addChild(new Laya.Camera(0, 0.3, 1000))) as Laya.Camera;
		...
		private onModelOk(): void {
			...
			this.camera.addComponent(CameraFollowScript);
		...
		var uniformMap={
			...
			var customShader: number = Laya.Shader3D.nameKey.add("CustomShader2");
